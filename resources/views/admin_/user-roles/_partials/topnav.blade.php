<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
    ...
    <a href="{{ url('dashboard') }}"><img style="width: 75px !important; height:auto;" class="img-fluid navbar-brand" src="{{ asset('assets/img/logo-raw.png') }}"
            alt="logo"></a>
    <!-- Navbar Search Input-->
    ...
    <ul class="navbar-nav align-items-center ms-auto">
        ...
        <li class="nav-item dropdown no-caret d-none d-md-block me-3">
            ...
            <a href="" class="btn btn-primary  fw-500 me-sm-3 mb-3 mb-sm-0">Schedule a post <i class="ms-2" data-feather="calendar"></i></a>
            @endif --}}
        ...
        <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownInfo"
                href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false"><img class="img-fluid" src="{{ $profile_img }}" /></a>
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                aria-labelledby="navbarDropdownInfo">
                <h6 class="dropdown-header d-flex align-items-center">
                    <img class="dropdown-user-img" src="{{ asset('assets/img/profile-1.png') }}" />
                ...
                <form id="logout-form" action="{{ route('users.logout') }}" class="d-none">
                    @csrf
                </form>
            </div>
        </li>
