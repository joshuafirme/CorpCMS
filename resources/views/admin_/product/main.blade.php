                            ...
                            @foreach ($product as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-datatable btn-icon btn-transparent-dark me-2 btn-delete-product"
                                            data-id="{{ $item->id }}" data-name="{{ $item->product_name }}">
                    ...
                    <form id="viewOrderForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="product_slug" readonly>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="product_description" rows="3" readonly></textarea>
                            </div>
