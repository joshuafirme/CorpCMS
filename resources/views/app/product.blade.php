                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="p-3">
                                    <div class="border rounded bg-light d-flex align-items-center justify-content-center" style="height: 400px;">
                                        <img id="mainImage" src="https://m.media-amazon.com/images/I/71yI9JssjYL._SY522_.jpg" class="img-fluid rounded object-fit-cover h-100" alt="Unseen Wins Book">
                                    </div>
                                    <div class="d-flex gap-2 justify-content-center mt-3">
                                        <img src="https://m.media-amazon.com/images/I/71yI9JssjYL._SY522_.jpg" class="img-thumbnail preview-thumb" onclick="changePreview(this)" style="width: 70px; height: 100px; object-fit: cover; cursor: pointer; border: 2px solid #272829;">
                                        <img src="https://placehold.co/400x500?text=Back+Cover" class="img-thumbnail preview-thumb" onclick="changePreview(this)" style="width: 70px; height: 100px; object-fit: cover; cursor: pointer;">
                                        <img src="https://placehold.co/400x500?text=Sample+Page" class="img-thumbnail preview-thumb" onclick="changePreview(this)" style="width: 70px; height: 100px; object-fit: cover; cursor: pointer;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 d-flex flex-column justify-content-between p-4">
                                ...
                                <div>
                                    <h3 class="text-primary fw-bold mb-2">Unseen Wins</h3>
                                    <p class="text-muted mb-1">by Coach Xavier Nunag</p>
                                    <h5 class="text-secondary fw-semibold mt-3 mb-2">$18.50</h5>
                                    <p class="text-dark mb-2">
                                        A heartfelt book for parents and coaches who still believe in doing things right. Coach Xavier shares timeless lessons on character, resilience, and the values that matter most in youth sports.
                                    </p>
                                ...
                                <div class="mt-4 d-flex gap-3">
                                    <a href="https://www.amazon.com/Unseen-Wins-Parents-Coaches-Believe-ebook/dp/B0F9XBS2QB" target="_blank" class="btn btn-primary px-4">Buy on Amazon</a>
