...
{{-- <script src="{{ asset('libs/js/vue.global.js') }}"></script>

<script src="{{ asset('libs/js/axios.js') }}"></script> --}}

<script src="{{ asset('libs/js/custom/scripts.js') }}"></script>
...
{{-- <script type="text/javascript">
    window.$crisp = [];
    window.CRISP_WEBSITE_ID = "66a74b48-aa81-4e33-a247-64c701e44282";
    (function() {
        d = document;
