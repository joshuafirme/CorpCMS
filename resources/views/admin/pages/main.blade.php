                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="overflow-auto img-container mt-2">
                                    <img width="100%" class="img-preview" id="image"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="order" class="form-control"  min="1" step="1">
                            </div>
                            <div class="col-md-6">
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/page-content', Str::lower(Str::slug($item->slug))) }}"
            ...
            <div class="modal-content p-4">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12 mb-3">
                            <label for="formFile" class="form-label">Cover Image</label>
                            <input class="form-control file-upload" name="image" type="file" id="formFile"
